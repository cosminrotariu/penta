...
public class AnimalShelterServiceTest {
    ...
    public void createShelter_SavesOk() {
        AnimalShelterRepo shelterRepositoryMock = Mockito.mock(AnimalShelterRepo.class);
    ...
    @Mock
    private AnimalShelterRepo animalShelterRepositoryMock;
